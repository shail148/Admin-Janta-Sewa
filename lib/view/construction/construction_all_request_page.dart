import 'package:admin_jantasewa/controllers/construction/construction_controller.dart';
...
class ConstructionAllRequestPage extends StatefulWidget {
  const ConstructionAllRequestPage({super.key});

  @override
  State<ConstructionAllRequestPage> createState() =>
      _ConstructionAllRequestPageState();
}

class _ConstructionAllRequestPageState
    extends State<ConstructionAllRequestPage> {
  final c = Get.put(ConstructionWorkController(), permanent: true);
            ...
            Expanded(
              child: Obx(() {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    final construction = list[i];
                    return CustomInfoCard(
                      title: construction.workId,
                      rows: [
                        /* InfoRowData(
                          icon: Icons.perm_identity_outlined,
                          text: 'ID : ${construction.userId}',
                        ), */
                        ...
                        InfoRowData(
                          ...
                          context: context,
                          builder: (context) => UserDetailBottomSheet(userId: construction.userId),
                         );
                       },
                        ...
                        InfoRowData(
                          ...
                          text: 'Requested Date : ${construction.date}',
                        ),

                        InfoRowData(
                          icon: Icons.chat,
                          text: construction.message,
                        ),
                      ],
                      description: construction.title,
                      status: construction.status,
                      statusColor: c.statusColor(construction.status),
                      buttonText: 'View',
                      onButtonTap: () => Get.to(
