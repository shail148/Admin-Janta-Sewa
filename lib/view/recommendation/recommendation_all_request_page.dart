import 'package:admin_jantasewa/controllers/recommendation/recommendation_controller.dart';
...
import 'package:admin_jantasewa/view/recommendation/recommendation_details_page.dart';
...
class RecommendationAllRequestPage extends StatefulWidget {
  const RecommendationAllRequestPage({super.key});

  @override
  State<RecommendationAllRequestPage> createState() =>
      _RecommendationAllRequestPageState();
}

class _RecommendationAllRequestPageState
    extends State<RecommendationAllRequestPage> {
  final c = Get.put(RecommendationController(), permanent: true);
            ...
            Expanded(
              child: Obx(() {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    final recommendation = list[i];
                    return CustomInfoCard(
                      title: recommendation.recommendationId,
                      rows: [
                        /* InfoRowData(
                          icon: Icons.perm_identity_outlined,
                          text: 'ID : ${recommendation.userId}',
                        ), */
                         ...
                         InfoRowData(
                          ...
                          context: context,
                          builder: (context) => UserDetailBottomSheet(userId: recommendation.userId),
                         );
                       },
                        ...
                        InfoRowData(
                          ...
                          text: 'Requested Date : ${recommendation.date}',
                        ),
                      ...
                      statusColor: c.statusColor(recommendation.status),
                      buttonText: 'View',
                      onButtonTap: () => Get.to(
