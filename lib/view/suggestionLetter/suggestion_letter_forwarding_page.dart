...
class SuggestionLetterForwardingPage extends StatefulWidget {
  const SuggestionLetterForwardingPage({super.key});

  @override
  State<SuggestionLetterForwardingPage> createState() =>
      _SuggestionLetterForwardingPageState();
}

class _SuggestionLetterForwardingPageState
    extends State<SuggestionLetterForwardingPage> {
