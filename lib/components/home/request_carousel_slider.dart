             ...
             Container(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: allrequestbgColor?? AppColors.btnBgColor,
                ),
                child: Row(children: [
                  Text(
                  "All Request",
...
class _RequestCarouselState extends State<RequestCarousel> {
  ...
  final List<RequestCard> cards = const [
    RequestCard(
      ...
      childWidget: Icon(Icons.description_outlined, color: Colors.white, size: 24),
    ),
    ...
    RequestCard(
      ...
      isPositive: false,
      childWidget: Icon(Icons.pending_actions_sharp, color: Colors.white, size: 24),
       gradientColor: LinearGradient(
